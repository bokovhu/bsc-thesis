...
public class SDFOpSubtract implements PerPointSDFGenerator, GLSLDistanceExpression {

    protected final PerPointSDFGenerator a;
    protected final PerPointSDFGenerator b;

    public SDFOpSubtract(
    ...
    public float getAt(float x, float y, float z) {
        return (float) Math.max(-1.0f * a.getAt(x, y, z), b.getAt(x, y, z));
    }
                        ...
                        new GLSLFunctionCallStatement(
                                ...
                                List.of(
                                        new GLSLBinaryExpressionStatement(
                                                new GLSLRawStatement("-1.0"),
                                                new GLSLRawStatement(
                                                        generatorAContext.resultVariable()),
                                                "*"
                                        ),
